...
const PaySlip: React.FC = () => {
  ...
  const generatePDFAndPost = () => {
    if (payslipRef.current && payrollData) {
      ...
      html2canvas(element, { scale: 2 }).then((canvas) => {
        ...
        apiCaller
          .post("api/payroll_app/create-salary-slip/", formData)
          .then((response) => {
  ...
  return (
    <div className="mx-auto mt-8 max-w-4xl rounded-lg border bg-white p-6 shadow-lg">
